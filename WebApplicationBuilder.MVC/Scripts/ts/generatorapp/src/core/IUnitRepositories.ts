import { BaseInputAttributes } from "../domains/attributes/InputAttributes";

// Base class for input elements
export class InputUnit<T extends BaseInputAttributes> {
    element: HTMLInputElement;
  
    constructor(type: string, id: string, attributes: Partial<T> = {}) {
